    ...
    <main className="min-h-screen bg-gray-50 flex flex-col justify-between">
      ...
      <div className="w-full max-w-6xl mx-auto px-4 py-16 flex-grow">
        ...
        <div className="flex flex-col items-center justify-center mb-20">
          ...
          <div className="flex flex-col items-center bg-white p-10 md:p-16 rounded-3xl border border-gray-200 shadow-md w-full max-w-3xl mb-16">
            
            {/* Logo ve İsim (Büyütüldü ve boşluk arttı) */}
            <div className="flex items-center gap-4 mb-10">
              {/* Siyah Yuvarlak ve 4 Beyaz Noktalı Logo */}
              ...
              <span className="text-4xl font-extrabold text-gray-900 tracking-tight">omegletest.online</span>
            </div>

            {/* Buton Üstü Yazı (Daha vurgulu ve boşluklu) */}
            ...
            {/* Sahte Kamera Butonu (Boyutu büyütüldü) */}
            <Link 
              href="/404" 
              className="flex items-center gap-3 bg-blue-500 text-white px-10 py-5 rounded-2xl shadow-sm hover:shadow-lg hover:bg-blue-600 hover:-translate-y-1 transition-all duration-300 font-bold text-2xl group"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm col-span-1 md:col-span-1">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">support@omegletest.online</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">privacy@omegletest.online</p>
                </div>
              </div>
            </div>
          </div>
