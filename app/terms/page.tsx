  ...
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col justify-between">
      ...
      <div className="w-full max-w-6xl mx-auto px-4 py-16 flex-grow">
        ...
        {/* Üst Kısım: Contact Sayfasındaki Birebir Aynı Logo ve Buton Kartı */}
        <div className="flex flex-col items-center justify-center mb-16">
          ...
          <div className="flex flex-col items-center bg-white p-8 md:p-16 rounded-3xl border border-gray-200 shadow-md w-full max-w-3xl text-center">
            ...
            {/* Logo ve İsim (Mobilde alt alta, PC'de yan yana) */}
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-10 w-full">
              ...
              {/* Responsive Metin Boyutu ve Kelime Kırma */}
            ...
            {/* Sahte Kamera Butonu (404'e gider) */}
            <Link 
              href="/404" 
