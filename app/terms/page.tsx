    ...
    <>
      ...
      <div className="w-full max-w-4xl mx-auto px-4 pt-8 pb-12">
        ...
        <div className="text-center">
          ...
          <p className="text-pc-ink-2 text-base sm:text-lg">
      ...
      <div className="w-full flex-grow border-t-2 border-dashed border-pc-line">
        <div className="w-full max-w-4xl mx-auto px-4 py-10 sm:py-16">
          ...
          {/* Metin Kutusu */}
          <div className="pc-card-static p-6 sm:p-10 text-pc-ink-2 text-base sm:text-lg [&_p]:text-justify">

            <h2 className="pc-display text-xl sm:text-2xl text-pc-ink mb-4 mt-0">
            ...
            <h2 className="pc-display text-xl sm:text-2xl text-pc-ink mb-4">
              2. Age Restriction
            </h2>
            <p className="leading-relaxed mb-8">
