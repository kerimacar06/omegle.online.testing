    ...
    <>
      ...
      <main className="relative min-h-screen pop-page flex flex-col">
        ...
        <div className="w-full max-w-5xl mx-auto px-4 pt-8 pb-12">
          ...
          {/* Panel */}
          <div className="relative pop-card-static p-6 sm:p-8 text-center max-w-xl mx-auto rotate-1">
          ...
          <h1 className="pop-display text-2xl sm:text-3xl md:text-4xl text-pop-ink text-center mt-10 leading-tight">
