        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-10">
          ...
          <div className="neon-card flex flex-row sm:flex-col items-center text-left sm:text-center gap-4 sm:gap-0 p-4 sm:p-6 rounded-md">
            ...
            <div className="min-w-0">
              <h3 className="text-sm sm:text-sm md:text-lg font-bold text-neon-ink mb-1 sm:mb-3 leading-tight">Relevant Chats</h3>
              <p className="text-xs sm:text-sm text-neon-ink-2 leading-relaxed sm:text-justify">
          ...
          <div className="neon-card flex flex-row sm:flex-col items-center text-left sm:text-center gap-4 sm:gap-0 p-4 sm:p-6 rounded-md">
            ...
            <div className="min-w-0">
              <h3 className="text-sm sm:text-sm md:text-lg font-bold text-neon-ink mb-1 sm:mb-3 leading-tight">Safety & Privacy</h3>
              <p className="text-xs sm:text-sm text-neon-ink-2 leading-relaxed sm:text-justify">
          ...
          <div className="neon-card flex flex-row sm:flex-col items-center text-left sm:text-center gap-4 sm:gap-0 p-4 sm:p-6 rounded-md">
            ...
            <div className="min-w-0">
              <h3 className="text-sm sm:text-sm md:text-lg font-bold text-neon-ink mb-1 sm:mb-3 leading-tight">AI Moderation</h3>
              <p className="text-xs sm:text-sm text-neon-ink-2 leading-relaxed sm:text-justify">
