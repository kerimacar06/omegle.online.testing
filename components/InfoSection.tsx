    ...
    <>
      <div className="w-full max-w-6xl mx-auto mt-2 sm:mt-14 lg:mt-20 px-4 pb-6 sm:pb-10 pt-3 sm:pt-10 border-t border-neon-line">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-10">
          ...
          {/* Madde 1 */}
          <div className="neon-card flex flex-col items-center text-center p-2 sm:p-6 rounded sm:rounded-md">
            <div className="w-8 h-8 sm:w-12 sm:h-12 bg-neon-surface-2 text-neon-cyan rounded sm:rounded-md flex items-center justify-center mb-2 sm:mb-5 shrink-0">
              <svg className="w-4 h-4 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
            </div>
            <h3 className="text-xs sm:text-sm md:text-lg font-bold text-neon-ink mb-1 sm:mb-3 leading-tight">Relevant Chats</h3>
            <p className="text-xs sm:text-sm text-neon-ink-2 leading-tight sm:leading-relaxed sm:text-justify">
          ...
          {/* Madde 2 */}
          <div className="neon-card flex flex-col items-center text-center p-2 sm:p-6 rounded sm:rounded-md">
            <div className="w-8 h-8 sm:w-12 sm:h-12 bg-neon-surface-2 text-neon-violet rounded sm:rounded-md flex items-center justify-center mb-2 sm:mb-5 shrink-0">
            ...
            <h3 className="text-xs sm:text-sm md:text-lg font-bold text-neon-ink mb-1 sm:mb-3 leading-tight">Safety & Privacy</h3>
            <p className="text-xs sm:text-sm text-neon-ink-2 leading-tight sm:leading-relaxed sm:text-justify">
          ...
          {/* Madde 3 */}
          <div className="neon-card flex flex-col items-center text-center p-2 sm:p-6 rounded sm:rounded-md">
            <div className="w-8 h-8 sm:w-12 sm:h-12 bg-neon-surface-2 text-amber-400 rounded sm:rounded-md flex items-center justify-center mb-2 sm:mb-5 shrink-0">
              <svg className="w-4 h-4 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
            </div>
            <h3 className="text-xs sm:text-sm md:text-lg font-bold text-neon-ink mb-1 sm:mb-3 leading-tight">AI Moderation</h3>
            <p className="text-xs sm:text-sm text-neon-ink-2 leading-tight sm:leading-relaxed sm:text-justify">
