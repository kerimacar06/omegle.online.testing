    ...
    <>
      <div className="w-full max-w-6xl mx-auto mt-20 px-4 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Madde 1 */}
          <div className="flex flex-col items-center text-center p-6 bg-white border border-slate-200 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
            ...
            <h3 className="text-lg font-bold text-slate-800 mb-3">Relevant Chats</h3>
          ...
          <div className="flex flex-col items-center text-center p-6 bg-white border border-slate-200 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
            ...
            <h3 className="text-lg font-bold text-slate-800 mb-3">Safety & Privacy</h3>
            <p className="text-slate-500 text-sm leading-relaxed">
          ...
          <div className="flex flex-col items-center text-center p-6 bg-white border border-slate-200 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
            ...
            <h3 className="text-lg font-bold text-slate-800 mb-3">AI Moderation</h3>
            <p className="text-slate-500 text-sm leading-relaxed">
