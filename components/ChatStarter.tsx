    ...
    <div className="w-full max-w-2xl mx-auto mt-8 px-4 sm:px-6">
      ...
      <div className="bg-white p-6 sm:p-10 rounded-2xl shadow-sm border border-gray-100 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Link
            href="/chat/text"
            className="flex-1 bg-[#00bfff] hover:bg-blue-600 text-white font-bold py-4 px-6 rounded-xl transition-all duration-200 text-lg shadow-sm text-center transform hover:scale-[1.02]"
          >
            Text
          </Link>
