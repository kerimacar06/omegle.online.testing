...
export default function Footer() {
  return (
    <footer className="w-full bg-slate-900 text-slate-300 py-8 md:py-10 border-t border-slate-800">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-sm text-slate-500 flex items-center gap-4">
            ...
            {/* Sosyal Medya İkonu */}
            <Link href="/" className="text-slate-500 hover:text-blue-400 transition-colors" title="Twitter">
