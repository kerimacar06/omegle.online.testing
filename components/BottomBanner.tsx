...
export default function BottomBanner() {
  return (
    <div className="w-full py-8 sm:py-14 md:py-20 border-t-2 border-dashed border-pc-line">
      <div className="max-w-2xl mx-auto px-4 flex flex-col items-center text-center">
        <div className="pc-card-static px-6 py-8 sm:px-10 sm:py-12 rotate-1 w-full">
          <h2 className="pc-display text-2xl sm:text-3xl md:text-4xl text-pc-ink mb-2 leading-tight">
            Ready to meet strangers worldwide?
          </h2>
          <p className="text-pc-ink-2 text-xs sm:text-lg leading-snug mb-6 md:mb-8">
          ...
          <Link href="/live-video" className="pc-btn inline-flex w-auto font-bold py-2.5 md:py-4 px-6 md:px-12 text-sm md:text-xl items-center justify-center gap-2 md:gap-3 animate-soft-bounce">
