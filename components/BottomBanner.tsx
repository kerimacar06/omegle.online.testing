...
export default function BottomBanner() {
  return (
    <div className="w-full py-8 sm:py-14 md:py-20 border-t-3 border-ink" style={{ borderTopWidth: 3 }}>
      <div className="max-w-2xl mx-auto px-4 flex flex-col items-center text-center">
        <div className="brut-card-static bg-surface px-6 py-8 sm:px-10 sm:py-12 rotate-1 w-full">
          <h2 className="brut-display text-2xl sm:text-3xl md:text-4xl text-ink mb-2 leading-tight">
            Ready to meet strangers worldwide?
          </h2>
          <p className="text-ink/70 text-xs sm:text-lg font-semibold leading-snug mb-6 md:mb-8">
          ...
          <Link href="/live-video" className="brut-btn inline-flex w-auto bg-brut-green text-ink font-bold py-2 md:py-4 px-6 md:px-12 rounded-full text-sm md:text-xl items-center justify-center gap-2 md:gap-3 animate-soft-bounce">
