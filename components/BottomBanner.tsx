...
export default function BottomBanner() {
  return (
    <div className="w-full py-8 sm:py-14 md:py-20 border-t border-neon-line">
      <div className="max-w-2xl mx-auto px-4 flex flex-col items-center text-center">
        ...
        <p className="text-neon-ink-2 text-xs sm:text-lg font-medium leading-none mb-6 md:mb-8">
