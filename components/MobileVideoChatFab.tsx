...
export default function MobileVideoChatFab({ watchId }: { watchId: string }) {
  ...
  return (
    <Link
      ...
      className={`pc-stamp lg:hidden fixed bottom-6 right-6 z-40 w-14 h-14 bg-pc-rust text-pc-card flex items-center justify-center transition-all duration-300 ${
