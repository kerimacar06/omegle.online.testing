...
export default function MobileVideoChatFab({ watchId }: { watchId: string }) {
  ...
  return (
    <Link
      ...
      className={`brut-sticker lg:hidden fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-brut-pink text-ink flex items-center justify-center transition-all duration-300 ${
